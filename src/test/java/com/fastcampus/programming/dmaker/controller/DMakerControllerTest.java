...
class DMakerControllerTest {
    ...
    void getAllDevelopers() throws Exception {
        DeveloperDto newDeveloperDto1 = DeveloperDto.builder()
                .developerSkillType(DeveloperSkillType.FULL_STACK)
                .developerLevel(DeveloperLevel.NEW)
                .memberId("memberId1")
                .build();

        DeveloperDto newDeveloperDto2 = DeveloperDto.builder()
                .developerSkillType(DeveloperSkillType.FULL_STACK)
                .developerLevel(DeveloperLevel.NEW)
                .memberId("memberId1")
                .build();
        ...
        given(dMakerService.getAllEmployedDevelopers())
                .willReturn(Arrays.asList(newDeveloperDto1, newDeveloperDto2));
